...
restart_button = Button(window, text="Restart", command= restart, font=('comic sans', 20),bg = 'red')
restart_button.place_forget()
...
hardb = Button ( text = 'HARD MODE 💀', bg = 'red', width = 14,command= lambda: game_start(3))
